...
public class HistoryViewModel extends ViewModel {
    ...
    private final DriverService driverService =
            ClientUtils.getRetrofit().create(DriverService.class);
    ...
    public void loadHistory(String jwtToken, Long driverId, String from, String to) {
        if (jwtToken == null || jwtToken.isEmpty()) {
            errorText.setValue("Nema tokena. Uloguj se prvo.");
            return;
        }
        if (driverId == null) {
            errorText.setValue("Nema driverId u TokenStorage.");
            return;
        }
        ...
        Call<List<DriverRideHistoryDTO>> call = driverService.getDriverRideHistory(
                "Bearer " + jwtToken,
                driverId,
                from,   // može null
                to      // može null
