...
public class DriverRideHistoryRecyclerAdapter
        extends RecyclerView.Adapter<DriverRideHistoryRecyclerAdapter.VH> {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.driver_card, parent, false); // pazi: driver_card.xml
        return new VH(v);
    }
